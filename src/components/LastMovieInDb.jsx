...
const LastMovieInDb = () => {
  ...
  useEffect(() => {
    async function getLastProduct() {
      const response = await fetch("http://pet-paradise.com.ar/api/products");
  ...
  return (
    <>
      ...
      <a className="btn btn-danger"  rel="nofollow" href={"http://pet-paradise.com.ar/products/"+lastProduct.id}>
